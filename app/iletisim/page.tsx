  ...
  return (
    <div className="min-h-screen bg-pink-50 py-12">
      <div className="container mx-auto px-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <p>Kızılay Mahallesi, Atatürk Bulvarı No: 123, 06420 Çankaya/Ankara</p>
              </div>
              <div className="flex items-center">
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-semibold mb-6 text-center">Bizi Ziyaret Edin</h2>
          <div className="aspect-w-16 aspect-h-9">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3060.4799271196166!2d32.85449661539594!3d39.92057797942407!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14d34f190a9cea8f%3A0xd3862ea8248d302a!2zS8SxesSxbGF5LCBBbmthcmE!5e0!3m2!1sen!2str!4v1623338282792!5m2!1sen!2str"
              width="100%"
              height="450"
              style={{ border: 0 }}
